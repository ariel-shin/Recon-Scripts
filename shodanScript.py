...
if len(argv) != 2:
    print ("Usage: python shodanScript.py iplist.txt")
    exit()
...
#open csv file
output_csv = open("shodanOutput.csv", "w+")

#write header line 
output_csv.write("IP,Last_shodan_update,ORG,ISP,OS,Product,Country,City, Open_port(s)\n")
